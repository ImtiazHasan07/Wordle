...
function gameEndedMessage(message, word, wordsGuessed) {
    ...
    document.getElementById('close-button').addEventListener('click', () => hideElement(document.getElementById('popup-container')))
    document.getElementById('continue-button').addEventListener('click', () => location.reload())
}
